...
routes.get('/', checkParamsMW_1.default, isExistMW_1.default, function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                basePath = './imgs';
                width = (0, resolveParam_1.default)(req.query.width);
                height = (0, resolveParam_1.default)(req.query.height);
                _a.label = 1;
            case 1:
                _a.trys.push([1, 4, , 5]);
            ...
            case 2:
                ...
                _a.label = 3;
            case 3:
                (0, sharp_1.default)("".concat(basePath, "/").concat(req.query.filename, ".jpg"))
                    .resize({ width: width, height: height })
                    .toFile("./output/".concat(req.query.filename, ".jpg"), function (e) {
                    if (e)
                        return res.send("Image ".concat(req.query.filename, ".jpg is not exist"));
                    res.sendFile(path_1.default.resolve() + "/output/".concat(req.query.filename, ".jpg"));
                });
                return [3 /*break*/, 5];
            case 4:
                err_1 = _a.sent();
